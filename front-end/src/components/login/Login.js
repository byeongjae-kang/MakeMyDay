  ...
  return ( (props.trigger) ? (
    <Grid>
      ...
      {/* elevation={10} */}
       ...
       <Typography align="center" style={linkStyle}>Or</Typography> 
        <TextField label="email" placeholder="enter email" fullWidth required />
        <TextField label="password" placeholder="enter password" fullWidth required style={textStyle}/>
        ...
        <FormControlLabel
          ...
          label="Remember me"
        />
        <Button variant="contained" type="submit" color="primary" fullWidth style={btnStyle}>Log in
        </Button>
